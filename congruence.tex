...
\chapter{Modular Arithmetic}\label{ch:congruence}
	...
	You can find some other proofs for Fermat's Little Theorem which use either number theoretic techniques or even combinatorial approaches. For a very strange yet interesting proof of this theorem, read the proof by counting necklaces in \textcite{engel_1997}.
