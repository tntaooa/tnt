...
\usepackage[style=philosophy-verbose,backend=biber,sortcites=true,classical=true,volnumformat=strings,volumeformat=romansc,]{biblatex}
...
\setmathfont[range={it},FakeBold=\fakemathbold,Scale=\scale]{ModernMT-ExtendedItalic-OldStandard-Italic.otf}
...
%\setmathfont[range={up/{latin,greek}},FakeBold=\fakemathbold,Scale=\scale]{ModernMT-ExtendedItalic-OldStandard-Italic.otf}
%\setmathfont[range={it/{num,latin,greek}},FakeBold=\fakemathbold,Scale=\scale]{ModernMT-ExtendedItalic-OldStandard-Italic.otf}
...
\AtBeginBibliography{\renewcommand{\mkbibnamefirst}[1]{#1}}
