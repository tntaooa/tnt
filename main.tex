...
\setmainfont[FakeBold=\fakebold,ItalicFont=ModernMT-ExtendedItalic.otf,ItalicFeatures={FakeBold=\fakebold},BoldItalicFont=OldStandard-BoldItalic.otf,SmallCapsFont={OldStandard-Regular.otf},SmallCapsFeatures={Letters=SmallCaps,FakeBold=\fakebold,RawFeature=+smcp},BoldFont=OldStandard-Bold.otf,BoldFeatures={FakeBold=\fakebold,SmallCapsFont=OldStandard-Regular.otf,SmallCapsFeatures={RawFeature=+smcp,Color=992211}},BoldItalicFeatures={FakeBold=0}]{ModernMT-Extended-OldStandard.otf}
\setmathfont[FakeBold=\fakebold,]{NewCMMath-Book.otf}
\setmathfont[FakeBold=\fakebold,range={"0000,"FFFF}]{Old Standard}
\setmathfont[range={it},FakeBold=\fakebold]{ModernMT-ExtendedItalic-OldStandard-Italic.otf}
\setmathfont[range={up/{num}},FakeBold=\fakebold]{ModernMT-Extended-OldStandard.otf}
\setmathfont[range={\symfrak,},FakeBold=\fakebold]{Asana Math}
\setmathfont[range={\int},Scale=1.6,]{Old Standard Italic}
\setmathfont[range={\sum,\prod},Scale=1.4]{Old Standard}
%\setmathfont[range={"005B,"005D,"0028,"0029,"007B,"007D},FakeBold=0]{Asana Math}
%\usepackage{mathspec}
