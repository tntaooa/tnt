...
\setmainfont[FakeBold=\fakebold,ItalicFont=ModernMT-ExtendedItalic.otf,BoldItalicFont=ModernMT-ExtendedItalic.otf,BoldItalicFeatures={FakeBold=\fakebold},SmallCapsFont={OldStandard-Regular.otf},SmallCapsFeatures={Letters=SmallCaps,FakeBold=\fakebold,RawFeature=+smcp},BoldFont=OldStandard-Bold.otf,BoldFeatures={FakeBold=0,SmallCapsFont=OldStandard-Bold.otf,SmallCapsFeatures={RawFeature=+smcp}}]{ModernMTStd-Extended.otf}
...
\setmathfont[range={\int},FakeBold=\fakebold]{Old Standard Italic}
\setmathfont[range={\sum,\prod},FakeBold=\fakebold,]{Old Standard}
...
\begin{dedication}
	...
	Paul Erd\fH{o}s, the man who loved only numbers.
\end{dedication}
