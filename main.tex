...
%\begin{itemize}
%	\item The website of the book contains the updates, errata, and new free materials that we regularly post on social media. Exclusive Olympiad problem-sets will be released on the website in the near future: \url{TopicsInNumberTheory.com}
	%	\href{https://facebook.com/TopicsInNumberTheory/}{\texttt{@TopicsInNumberTheory}}.
%	\item Facebook page: \url{@TopicsInNumberTheory}. This is our main page for feedback and reviews on the book. Feel free to post review, comment, solution, or suggestion you have about this book. Amir Hossein will create a forum for the book on AoPS so everyone can post their solutions to be added to the book later on.
%	\item If you find any mistake or typo in the book, we would be happy to hear it on Facebook or \url{info@TopicsInNumberTheory.com}.
%\end{itemize}
