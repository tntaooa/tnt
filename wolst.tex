...
\begin{document}
	...
	We are ready to prove Wolstenholme's theorem now.
		...
		\begin{problem}
			Let $p \geq 5$ be a prime and
				\begin{align*}
					\dfrac{1}{p-1} + \dfrac{2}{p-2} + \ldots + \dfrac{p-1}{1}=\dfrac{a}{b},
				\end{align*}
		...
		\begin{solution}
			Note that
				\begin{align*}
					\dfrac{a}{b} &= \sum_{i=1}^{p-1} \frac{p-i}{i} =\sum_{i=1}^{p-1} \left(\frac{p}{i} -1 \right)=\sum_{i=1}^{p-1} \dfrac{p}{i} - (p-1)
	...
	The following problem appears in \textcite[D23]{vandendriessche_lee_2007}.
		...
		\begin{problem} %[http://www.artofproblemsolving.com/community/c6h229692p1272166]
			...
			\begin{align*}
				1 + \dfrac {1}{2^s} + \dfrac {1}{3^s} + \ldots + \dfrac {1}{(p - 1)^s} \equiv 0 \pmod p.
			\end{align*}
		\end{problem}
