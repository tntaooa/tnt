...
\begin{document}
	...
	\nomenclature[floorceil]{$\lfloor x \rfloor$ and $\lceil x \rceil$}{The largest integer not greater than $x$ and the smallest integer integer not less than $x$ respectively.}
	\nomenclature[legendre]{$\left(\dfrac{a}{p}\right)$}{The Legendre symbol for an integer $a$ and prime $p$.}
	\nomenclature[jacobi]{$\left(\dfrac{a}{n}\right)$}{The Jacobi symbol for an integer $a$ and a positive integer $n$.}
