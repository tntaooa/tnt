...
\section{Open Questions In Primes}
	...
	\begin{conjecture}[Oppermann's Conjecture]
	...
	\begin{conjecture}[Brocard's conjecture]\label{open:brocard}
	...
	\begin{conjecture}[Andrica's Inequality]
		For all $n\geq1$,
		\begin{align*}
	...
	\begin{conjecture}[Mersenne Prime Problem]
		Is the number of Mersenne primes infinite?
	\end{conjecture}


	\begin{conjecture}[Rassias Conjecture]
