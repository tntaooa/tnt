...
\section{Introduction}
	...
	An improvement on this result is \textcite{panaitopol_2000}.
		\begin{theorem}
			For $n\geq 2$,
				\begin{align*}
					p_{1}\cdots p_{n}
